...
var win = window,
  ...
  var compute = window.getComputedStyle ? function(node){
...
win.HighchartsAdapter = {
  ...
  adapterRun: function (el, method) {
    ...
    if (method === 'width' || method === 'height') {
      return document.id(el).getStyle(method).toInt()
    }
  },
  ...
  animate: function (el, params, options) {
    ...
    if (isSVGElement && !el.setStyle) {
      ...
      // THANX
      el.getComputedStyle = function(property){
        return compute(el.element)(property);
      };
      // ENDTHANX
    }
   ...
   */
  offset: function (el) {
    var offsets = document.id(el).getOffsets();
    return {
      left: offsets.x,
      top: offsets.y
    };
